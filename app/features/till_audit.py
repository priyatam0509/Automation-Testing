...
class TillAudit:
    ...
    def __init__(self):
        ...
        TillAudit.navigate_to()

    @staticmethod
    def navigate_to():
        """
        Navigates to the Till Audit feature module.

        Returns:
            Returns the result of execution of Navi.navigate_to()
        """
        return Navi.navigate_to("till audit")

    def configure(self, till_id, config):
        """
        Configures tenders and amounts in the Till Audit feature module. Can be used to add
        ...
        Example: 
            ...
            ta = till_audit.TillAudit()
            tb.configure("70", till_audit_info)
            True
        """
        ...
        while time.time() - starttime < 5:
            error_message = mws.check_for_errors()
            if error_message:
