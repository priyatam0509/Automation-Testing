"""
    File name: Postpay_Giftcard.py
    Tags:
    Description: This will perform Fuel, Dry Stock and car wash postPay sale with Giftcard.
    ...
    Date created: 2020-1-29 14:53:24
    Date last modified:
    Python Version: 3.7
"""
...
class Postpay_Giftcard():
    ...
    def fuel_postpay(self):
        """
        Zephyr Id : This will add fuel and Perform a postpay sale with Giftcard.
                      It will check receipt for gift card payment 
        Args: None
        Returns: None
        """
        ...
        pos.pay_card(brand='CITGO', card_name='GiftCard1')
    ...
    def fuel_carwash_drystock(self):
        """
        Zephyr Id : This will add fuel, dry stock and car wash and Perform a postpay sale with Giftcard.
                      Also it will check receipt for gift card payment.                    
        Args: None
        Returns: None
        """ 
        # Retrieve before sale card balance of giftcard
